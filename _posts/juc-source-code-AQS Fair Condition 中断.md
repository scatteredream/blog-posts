...
title: 一行一行源码分析清楚 AbstractQueuedSynchronizer (二)(转自Javadoop)
date: 2017-10-20
tags: 
- AQS
- 源码
...
基本上本文把以上几点都说清楚了，我假设读者看过[上一篇文章中对 AbstractQueuedSynchronizer 的介绍 ](/post/AbstractQueuedSynchronizer)，当然如果你已经熟悉 AQS 中的独占锁了，那也可以直接看这篇。各小节之间基本上没什么关系，大家可以只关注自己感兴趣的部分。
